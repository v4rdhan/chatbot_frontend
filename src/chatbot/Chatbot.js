      ...
      <div className="vh-100 d-flex justify-content-center align-items-center py-2">
        <div className="h-100 card-color-primary w-25 px-3 rounded-4 mx-3">
          ...
          <div className="w-100">
            <input
              type="text"
              placeholder="Search"
              className="search-input card-color-secondary border rounded-5 w-100 px-3 py-1"
            />
          </div>
        ...
        <div className="d-flex justify-content-between align-items-center flex-column card-color-primary w-75 mx-3 h-100 rounded-4">
          ...
          <div
            className={
              chat === ""
                ? "d-flex justify-content-center align-items-center flex-column h-100 w-100"
                : "d-flex justify-content-start align-items-center flex-column h-100 w-100 py-4"
            }
          >
            {chat === "" ? (
              <h1 className="text-center">Wellcome to chat</h1>
            ) : (
              <div className="sender-message w-100 px-3">
                <p className="card-color-secondary px-2 py-1 m-0">
                  {chat.lastChat}
                </p>
              </div>
            )}
          ...
          <div className="position-relative w-100 px-2 my-3">
            ...
            ></img>
            <input
              className="message-input border rounded-5 w-100 px-3 py-1"
              type="text"
              placeholder="Message"
            />
          </div>
